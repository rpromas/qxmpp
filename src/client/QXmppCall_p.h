...
//         { .pt = 111, .name = u"opus"_s, .channels = 2, .clockrate = 48000, .gstPay = "rtpopuspay"_L1, .gstDepay = "rtpopusdepay"_L1, .gstEnc = "opusenc"_L1, .gstDec = "opusdec"_L1, .encProps = { { "inband-fec"_L1, true }, { "frame-size"_L1, 40 } } },
        { .pt = 112, .name = u"opus"_s, .channels = 1, .clockrate = 48000, .gstPay = "rtpopuspay"_L1, .gstDepay = "rtpopusdepay"_L1, .gstEnc = "opusenc"_L1, .gstDec = "opusdec"_L1, .encProps = { { "dtx"_L1, 1 }, { "inband-fec"_L1, 1 }, {"packet-loss-percentage"_L1, 15}, { "frame-size"_L1, 20 }, { "bitrate"_L1, 16000 },{"bitrate-type"_L1, 0/*cbr*/}, {"audio-type"_L1, 2048/*voip*/} } },
